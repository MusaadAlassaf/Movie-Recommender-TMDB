    ...
    <div class="container-fluid" >
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
       ...
       <input  type="search" style="margin-left:85%;" placeholder="Search" aria-label="Search" name="search">
            <button class="btn btn-outline-success searchh" href="search.php" type="submit">Search</button>
        </form>
      </div>
    </div>
  </nav>
...
<main>
  ...
  <div class="container marketing">
    ...
    <div class="row">
            ...
            <button type="button" class="btn btn-secondary" data-toggle="collapse" data-target="#demo1" >Request Movie or TvSeries &raquo;</button>

<div id="demo1" class="collapse" style="margin-top: 20px;">
    
   <form method="POST" action="checkadd.php">
        <?php
      if(isset($_GET['error'])){
